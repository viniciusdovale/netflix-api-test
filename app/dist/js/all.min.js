...
function GithubController(a,b){a.sendMessage=function(c){a.data=[];a.loading=!0,a.showFilm=!1;var d="director="+c.director,e="actor="+c.actor,f=c.minRatings,g=c.maxRatings,h=c.typeOf;void 0!==c.actor?a.API_URL="http://netflixroulette.net/api/api.php?"+e:void 0!==c.director?a.API_URL="http://netflixroulette.net/api/api.php?"+d:void 0!==c.director&&void 0!==c.actor&&(a.API_URL="http://netflixroulette.net/api/api.php?"+d+"&"+e);var i={url:a.API_URL,method:"GET"};b(i).success(function(b){var c=[];angular.forEach(b,function(b,d){b.rating>=f&&b.rating<=g&&b.mediatype===h?(c.push(b),a.showFilm=!0,a.loading=!1,a.noFilm=!1):(a.loading=!1,a.noFilm=!0)}),a.result=c[0]}).error(function(b){a.loading=!1,a.error=!0,a.noFilm=!0})}}function GithubController(a,b){a.sendMessage=function(c){a.data=[];a.loading=!0,a.showFilm=!1;var d="director="+c.director,e="actor="+c.actor,f=c.minRatings,g=c.maxRatings,h=c.typeOf;void 0!==c.actor?a.API_URL="http://netflixroulette.net/api/api.php?"+e:void 0!==c.director?a.API_URL="http://netflixroulette.net/api/api.php?"+d:void 0!==c.director&&void 0!==c.actor&&(a.API_URL="http://netflixroulette.net/api/api.php?"+d+"&"+e);var i={url:a.API_URL,method:"GET"};b(i).success(function(b){var c=[];angular.forEach(b,function(b,d){b.rating>=f&&b.rating<=g&&b.mediatype===h?(c.push(b),a.showFilm=!0,a.loading=!1,a.noFilm=!1):(a.loading=!1,a.noFilm=!0)}),a.result=c[0]}).error(function(b){a.loading=!1,a.error=!0,a.noFilm=!0})}}!function(){angular.module("requestModule",[])}(),angular.module("requestModule").controller("GithubController",GithubController),GithubController.$inject=["$scope","$http"],angular.module("requestModule").directive("showResults",function(){return{templateUrl:"app/modules/request/results.view.html",replace:!0,restric:"E",controllerAs:"GithubController"}}),angular.module("requestModule").directive("uiAlert",function(){return{templateUrl:"app/modules/request/alert.view.html",replace:!0,restric:"E"}}),function(){"use strict";angular.module("netflixapi",["requestModule"])}(),function(){angular.module("requestModule",[])}(),angular.module("requestModule").controller("GithubController",GithubController),GithubController.$inject=["$scope","$http"],angular.module("requestModule").directive("showResults",function(){return{templateUrl:"app/modules/request/results.view.html",replace:!0,restric:"E",controllerAs:"GithubController"}}),angular.module("requestModule").directive("uiAlert",function(){return{templateUrl:"app/modules/request/alert.view.html",replace:!0,restric:"E"}});